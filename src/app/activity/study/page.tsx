...
const activities: Array<{
  ...
  { id: '1', title: '2025-2 알고리즘 스터디', date: '2025-12-01', participants: ['홍길동', '박명수'] },
  { id: '2', title: '2025-2 프론트엔드 스터디', date: '2025-12-01', participants: ['김지민', '오수민', '이준호'] },
  { id: '3', title: '2025-2 백엔드 스터디', date: '2025-12-01', participants: ['정다은'] },
  { id: '4', title: '2025-2 CS 스터디', date: '2025-12-01', participants: ['장예린', '하준'] },
  { id: '5', title: '2025-1 면접 준비 스터디', date: '2025-12-01', participants: ['윤서진', '최재훈', '박성우', '윤하'] },
  { id: '6', title: '2025-1 협업 스터디', date: '2025-12-01', participants: ['임도현', '서유진'] },
];
    ...
    <div className="min-h-screen bg-[#f7f2e9] text-[#2b2b2b]">
      ...
      <main className="mx-auto max-w-5xl px-6 pb-16 pt-10">
        <section className="flex flex-col items-center text-center gap-4">
          ...
          <h1 className="text-2xl font-semibold sm:text-3xl">Our Study</h1>
