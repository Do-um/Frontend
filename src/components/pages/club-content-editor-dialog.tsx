        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="mt-6 space-y-4">
            <section className="rounded-[24px] border border-[#dbe7ea] bg-white/80 p-4 shadow-[0_12px_30px_rgba(47,74,91,0.05)] sm:p-5">
              <div className="mb-4">
                <h3 className="text-sm font-semibold text-[#243845]">소개 영역</h3>
                <p className="mt-1 text-xs leading-5 text-[#748690]">
                  첫 화면 배너와 소개 문구를 한 묶음으로 수정합니다.
                </p>
              </div>
            ...
            <section className="rounded-[24px] border border-[#dbe7ea] bg-white/80 p-4 shadow-[0_12px_30px_rgba(47,74,91,0.05)] sm:p-5">
              <div className="mb-4">
                <h3 className="text-sm font-semibold text-[#243845]">활동 섹션</h3>
                <p className="mt-1 text-xs leading-5 text-[#748690]">
                  정규 활동과 히스토리 섹션의 제목을 이곳에서 수정합니다.
                </p>
              </div>
            ...
            <section className="rounded-[24px] border border-[#dbe7ea] bg-white/80 p-4 shadow-[0_12px_30px_rgba(47,74,91,0.05)] sm:p-5">
              <div className="mb-4">
                <h3 className="text-sm font-semibold text-[#243845]">스터디 섹션</h3>
                <p className="mt-1 text-xs leading-5 text-[#748690]">
                  Learn / Grow / Share 영역의 카피와 이미지를 정리합니다.
                </p>
              </div>
